...
**Nombre del alumno**: Facundo Mingorance
...
- **Métodos**:
    ...
    - `agregarHospedaje(String codServicio, double porcentajeDescuento, boolean enPromocion, String hospedaje, double precioPorNoche)`: Agrega un servicio de hospedaje al sistema sin el dia de reserva. Arroja una excepción si el código ya se encuentra ingresado.
